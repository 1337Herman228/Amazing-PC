          ...
          <header className="second-header">
               <nav className="second-navbar container">
                    ...
                    <button 
                         ...
                         className={ isMenuOpen ? `second-navbar__button visible-mobile second-navbar__button--pressed` : `second-navbar__button visible-mobile `}>
               ...
               <ul className={ isMenuOpen ? `second-mobile-navbar visible-mobile second-mobile-navbar--open` : `second-mobile-navbar visible-mobile second-mobile-navbar--close`}>
                    ...
                    <Link href='#performance' className="second-mobile-navbar__item">
                         Производительность
                    </Link>
                    <Link href='#kits-and-prices' className="second-mobile-navbar__item">
                         Комплектация и цены
                    </Link>
               </ul>
          </header>
