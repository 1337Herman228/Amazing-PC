...
export default function AdminNavbar() {
    ...
    const markCurrentLink = (currentUrl) => {
        ...
        for(var i=0;i<links.length;i++) {
            ...
            if(links[i].getAttribute('href').includes('/' +currentUrl.split('/')[1] + '/' + currentUrl.split('/')[2] )) {
    ...
    return (
        ...
        <header className="admin-navbar-header">
            <div className="header__inner container">
                ...
                <Link className="header__logo logo link-to-check" href="/admin">
                    <span className="logo__text uppercase-text">Main Page</span>
                </Link>
                ...
                <nav className="header__menu hidden-mobile">
                    <ul className="header__menu-list">
                        ...
                        <li className="header__menu-item">
                            <Link className="header__menu-link link-to-check uppercase-text" href="/admin/parts/view">Комплектующие</Link>
                        </li>
                        <li className="header__menu-item">
                            <Link className="header__menu-link link-to-check uppercase-text" href="/admin/pc">ПК</Link>
                        </li>
                    ...
                    <nav className="header__side-button-menu-list">
                        <Link className="header__menu-link uppercase-text" href="/sign-in">Выйти</Link>
                        <button
                            onClick={openModal}
