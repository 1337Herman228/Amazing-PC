          ...
          <footer className="footer">
                         ...
                         <li className="footer-list__item" key={index}>
                              ...
                              <ul className="footer-list__item__body">
                                   {item.body.map((item, index) =>
                                        <Link href={item.link} className="footer-list__item__body__link" key={index}>
                                             {item.name}
                                        </Link>
                                   )}
                              </ul>
               ...
               <div className="footer-social">
                    <ul className="footer-social__list">
                         ...
                         <Link key={index} target="_blank" href={item.link} className="footer-social__list__item">
                              <img
                                   ...
                                   loading="lazy"
                              />
                              <span className="footer-social__list__item__name hidden-tablet">{item.title}</span>
                         </Link>
                         )}
                    </ul>
               </div>
