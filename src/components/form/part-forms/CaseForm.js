    ...
    return (
        <div className='case-form'>
            <div className='case-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? caseData?.maxCpuCoolerHeight : ''}
            ...
            <div className='case-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? caseData?.maxLiquidCoolingLength : ''}
                    onlyPositiveDigits={true}
            ...
            <div className='case-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? caseData?.extensionSlotsQuantity : ''}
                    onlyPositiveDigits={true}
            ...
            <div className='case-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? JSON.parse(caseData?.possibleFormFactors).join(', ') : ''}
