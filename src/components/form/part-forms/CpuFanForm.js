...
const CpuAirCoolingForm = ({ register, unregister, errors, isEditForm, cpuAirCooling }) => {
    ...
    return (
        <div className='cpu-air-cooling-form'>
            ...
            <div className='cpu-air-cooling-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? cpuAirCooling?.maxNoiseLevel : ''}
            ...
            <div className='cpu-air-cooling-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? JSON.parse(cpuAirCooling?.sockets).join(', ') : ''}
...
const CpuLiquidCoolingForm = ({ register, unregister, errors, isEditForm, cpuLiquidCooling }) => {
    ...
    return (
        <div className='cpu-liquid-cooling-form'>
            <div className='cpu-liquid-cooling-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? cpuLiquidCooling?.fansQuantity : ''}
                    onlyPositiveDigits={true}
                    labelText='Количество вентиляторов'
                    require={true}
                    name='fansQuantity'
            ...
            <div className='cpu-liquid-cooling-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? cpuLiquidCooling?.maxNoiseLevel : ''}
                    labelText='Максимальный уровень шума (дБ)'
                    require={true}
                    name='maxNoiseLevel'
                    minLength={0}
            ...
            <div className='cpu-liquid-cooling-form__input'>
                <AuthInput
                    defaultValue={isEditForm ? JSON.parse(cpuLiquidCooling?.sockets).join(', ') : ''}
                    labelText='Поддерживаемые сокеты'
                    require={true}
                    name='sockets'
                    minLength={0}
...
const CpuFanForm = ({ register, unregister, errors, isEditForm, isFormSubmitted, cpuAirCooling, cpuLiquidCooling }) => {

    const defaultCpuFanType = cpuAirCooling != null ? 'Воздушное' : cpuLiquidCooling != null ? 'Жидкостное' : '';
        ...
        <div className='cpu-fan-form'>
           <input 
            ...
            { !isEditForm &&
                ...
                name='Тип охлаждения' 
                options={cpuFanTypes}
                isError={isFormSubmitted ? (cpuFanType ? null : true) : null}
            />
            }
            
            <p className='error-message'>{isFormSubmitted ? (cpuFanType ? null : 'Выберите тип охлаждения') : null}</p>
