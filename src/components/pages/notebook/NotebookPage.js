...
const notebook_header_info = {
     ...
     description:'Мощные модели игровых ноутбуков, оснащенные передовыми технологиями NVIDIA GeForce RTX 40 и высокоэффективными процессорами Intel Core 13-го поколения. Отличный выбор для тех, кому важно сочетание мобильности и производительности в одном устройстве. Испытайте свое превосходство в играх прямо сейчас!',
...
const NotebookPage = () => {
     ...
     return(
          <>
          <Header header_info={notebook_header_info}/>
          <Catalog categories={notebook_categories} products_list={notebooks} is_notebook={true}/>
          </>
     )
}
