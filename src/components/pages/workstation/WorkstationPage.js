...
const workstation_header_info = {
     ...
     description:'Подберите компьютер, который подойдет для любого направления! Либо самостоятельно соберите комплектацию ПК и проверьте комплектующие на совместимость с помощью конфигуратора.',
...
const workstation_categories=[
     {
          ...
          category_description:'Современные рабочие компьютеры с процессорами Intel Core и видеокартами NVIDIA GeForce RTX предлагают идеальное сочетание производительности и стоимости для профессиональных задач. Они обеспечивают максимум эффективности для работы с графическими и многозадачными приложениями без лишних затрат.',
...
const WorkstationPage = () => {
     ...
     return(
          <>
          <Header header_info={workstation_header_info}/>
          <Catalog categories={workstation_categories} products_list={workstations} />
