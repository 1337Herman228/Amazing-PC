...
const ConfigurationCard =(
    ...
    useEffect(() => {
        const handleResize = () => {
            const elementsP = document.querySelectorAll('.configuration-card__description');
            const _maxHeightP = Math.max(...Array.from(elementsP).map(el => el.querySelector('p').offsetHeight));
        ...
        // <Link>
            <div className='configuration-card'>
                ...
                <div className='configuration-card__header'>
                    ...
                    <hr/>
                    <div className='configuration-card__description' style={{ minHeight: `${maxHeight}px` }}>
                        <p>{description}</p>
                    </div>
                    <div className='configuration-card__links'>
                        <Link href={link_to_configurator} className='configuration-card__links-config transparent-link-with-border'>
                            <img
                        ...
                        <Link href='#' className='configuration-card__links-more transparent-link-with-border'>Подробнее</Link>
                    </div>
                    <hr/>
                </div>
                <ul className='components-list'>
                    ...
                    <li className='components-list__item'>
                        ...
                        <div className='components-list__item-info'>
                            <span className='components-list__item-info-title'>Операционная система:</span>
                            <span className='components-list__item-info-name'>{os}</span>    
                        </div>
                    </li>
                </ul>
            </div>
