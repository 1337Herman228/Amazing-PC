...
const PopularPcCard = ({name,description,min_price,img,mark,link}) => {
          ...
          <div className='popular-body'>
               <div className='popular-body__img-container'>
                    <div className='popular-body__img-container__mark'>
                         {mark !=='none'? 
                              <span className={`popular-body__img-container__mark--new mark mark-${mark}`}>
                                   {mark}
                              </span> : null
                         }
                    </div>
               ...
               <div className='popular-body__buttons'>
                    <Link href={`/gaming-pc/${link}`} className='popular-body__buttons--learn-more button-gray-no-border'>
                         Узнать больше
                    </Link>
                    <Link href={`/gaming-pc/${link}/config`} className='popular-body__buttons--config green-circle-filled-link'>
               ...
               <footer className='popular-body__footer'>
                    <Link href={`/gaming-pc/${link}`} className='popular-body__footer__title h3'>
                         {name}
                    </Link>
