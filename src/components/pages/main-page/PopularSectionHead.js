...
const PopularSectionHead = () => {
     ...
     const addScrollToButtonRight = () => {
          const scrollButton = document.querySelector('.popular-head__controls-btn-right');
     ...
     const addScrollToButtonLeft = () => {
          const scrollButton = document.querySelector('.popular-head__controls-btn-left');
          const scrollableBlock = document.querySelector('.popular-container');
          let scrollDistance = 390; // Расстояние, на которое будет прокручиваться контент
          let animationDuration = 500;  // Длительность анимации, мс
     ...
     return(
          <div className='popular-head'>
               ...
               <div className='popular-head__controls'>
                    <Link href='/gaming-pc' className='popular-head__controls-view-all green-circle-bordered-link hidden-mobile'>
                         Смотреть все модели
                    </Link>
                    <button disabled className='popular-head__controls-btn-left green-circle-bordered-button'>
