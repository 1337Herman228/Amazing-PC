...
import PopularPcCard from './PopularPcCard'
import PopularSectionHead from './PopularSectionHead'
...
export default function MainPage() {
     ...
     const openFirstDialog = () => {
          const firstDialogElement = document.querySelector('.services__list__item__accordeon');
          firstDialogElement.setAttribute('open', 'true');
     }

     const CardTemplate = (card_info,i) => {
          ...
          return(
               <div key={i} >
                    <div className='carousel-card hidden-mobile' style={contentStyleDesktop}>
                         <aside className='carousel-card__aside'>
                              <h2 className='carousel-card__aside-title'>{card_info.title}</h2>
                              <div className='carousel-card__aside-description'>
                                   <p>{card_info.description}</p>
                              </div>
                              
                              {card_info.button_link !== 'none' && <Link className='carousel-card__link link-more-details' href={card_info.button_link}>Подробнее</Link>}
                         </aside>
                    </div>

                    <div className='carousel-card visible-mobile' style={contentStyleMobile}>
                         <aside className={card_info.button_link !== 'none' ? `carousel-card__aside` : `carousel-card__aside carousel-card__aside--no-button`}>
                              <h2 className='carousel-card__aside-title'>{card_info.title}</h2>
                              <div className='carousel-card__aside-description'>
                                   <p>{card_info.description}</p>
                              </div>
     ...
     return(
          ...
          <div className='carousel-container'>
               ...
               >
                    <Carousel speed={800} autoplay autoplaySpeed={5000} arrows infinite={true}>
                         {carousel_cards_info.map((card_info,i) => CardTemplate(card_info,i))}
                    </Carousel>
               </ConfigProvider>
          </div>
          ...
          <main className='container'>
               <section className='categories section'>
                    ...
                    <Link className='categories__gaming-pc gray-card' href='/gaming-pc'>
                              <img 
                                   width='500px'
                              ...
                              <div className='categories__gaming-pc-body'>
                                   <svg className='categories__gaming-pc-arrow' width="40" height="40" viewBox="0 0 89 87" fill="#c0ff01" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M11.751 2.95073C11.751 4.44573 12.9737 5.65906 14.4802 5.65906H78.8503L1.63129 82.2832C0.566914 83.3449 0.566914 85.0566 1.63129 86.1182C2.70112 87.1745 4.42596 87.1745 5.49579 86.1182L82.7094 9.48865V73.3674C82.7094 74.8624 83.932 76.0757 85.4385 76.0757C86.945 76.0757 88.1683 74.8624 88.1683 73.3674V2.95615C88.2005 1.49365 86.9068 0.209897 85.4331 0.241793H14.4802C12.9737 0.241793 11.751 1.45573 11.751 2.95073Z" fill="black"/>
                                   </svg>
                    ...
                    <Link href='/computers' className='categories__pc-in-stock gray-card'>
                         <img 
                              width='400px'
                              height='300px'
                         ...
                         <div className='categories__pc-in-stock-body'>
                              ...
                              <button className='categories__pc-in-stock-btn button-transparent-white'>Смотреть все модели</button>
                         </div>
                    </Link>

                    <Link href='/workstation'className='categories__work-station gray-card'>
                         <img 
                              width='500px'
                         ...
                         <div className='categories__work-station-body'>
                              ...
                              <button className='categories__work-station-btn button-transparent-white'>Смотреть все модели</button>
                         </div>
                    </Link>

                    <Link href='/notebook' className='categories__gaming-laptop gray-card'>
                         <img 
                              width='500px'
                         ...
                         <div className='categories__gaming-laptop-body'>
                              ...
                              <button className='categories__gaming-laptop-btn button-transparent-white'>Смотреть все модели</button>
                         </div>
                    </Link>

                    <Link href='/gaming-pc/custom' className='categories__custom-pc gray-card'>
                         <img 
                              width='500px'
                         ...
                         <div className='categories__custom-pc-body'>
                              ...
                              <button className='categories__custom-pc-btn button-transparent-white'>Смотреть все модели</button>
                         </div>
                    </Link>
               </section>
               ...
               <section className='popular section'>
                    ...
                    <div className='popular-container'>
                         {popular_pc_info.map((pc) => (
                              <PopularPcCard key={pc.name} name={pc.name} description={pc.description} min_price={pc.min_price} img={pc.img} mark={pc.mark} link={pc.link}/>
                         ))}
                    </div>
                    <div className='visible-mobile view-all-mobile-container'>
                         <Link href='/gaming-pc' className='view-all-mobile green-circle-bordered-link visible-mobile'>
                              Смотреть все модели
                         </Link> 
                    </div>
               </section>
               ...
               <section className='catalog section'>
                    <div className='catalog-about'>
                         ...
                         <div className='catalog-about__description'>
                              <p>В этом разделе вы можете увидеть какие комплектующие и элементы моддинга мы используем для апгрейда ПК. Или приобрести аксессуары для более комфортной работы или геймплея!</p>
                         </div>
                    </div>
                    <div className='catalog-navigation'>
                         <ul className='catalog-navigation__list'>
                              <li className='catalog-navigation__list-item'><Link className='catalog-navigation__list-item-link' href='/catalog/accessories'>Аксессуары</Link></li>
                              <li className='catalog-navigation__list-item'><Link className='catalog-navigation__list-item-link' href='/catalog/hardware'>Комплектующие</Link></li>
                              <li className='catalog-navigation__list-item'><Link className='catalog-navigation__list-item-link' href='/catalog/modding'>Моддинг</Link></li>
                         </ul>
                    </div>
               </section>
